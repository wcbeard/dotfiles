...
# c.TerminalIPythonApp.ipython_dir = u'/Users/FingerMan/.config/ipython'
...
# c.TerminalInteractiveShell.editor = 'mvim --remote-tab-wait-silent'
# c.IPythonWidget.editor = 'mvim --remote-tab-wait-silent'
c.IPythonWidget.editor = 'mvim'
c.IPythonWidget.colors = 'Linux'
c.IPythonWidget.banner = False
...
# c.TerminalInteractiveShell.banner1 = 'Python 2.7.2 (default, Jun 26 2011, 22:34:28) \nType "copyright", "credits" or "license" for more information.\n\nIPython 0.12 -- An enhanced Interactive Python.\n?         -> Introduction and overview of IPython\'s features.\n%quickref -> Quick reference.\nhelp      -> Python\'s own help system.\nobject?   -> Details about \'object\', use \'object??\' for extra details.\n'

# 
c.TerminalInteractiveShell.readline_parse_and_bind = ['tab: complete', '"\\C-l": clear-screen', 'set show-all-if-ambiguous on', '"\\C-o": tab-insert', '"\\C-r": reverse-search-history', '"\\C-s": forward-search-history', '"\\C-p": history-search-backward', '"\\C-n": history-search-forward', '"\\e[A": history-search-backward', '"\\e[B": history-search-forward', '"\\C-k": kill-line', '"\\C-u": unix-line-discard','"\\M-p": history-search-backward','"\\M-P": history-search-forward']
